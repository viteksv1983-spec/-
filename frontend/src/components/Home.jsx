            ...
            <section aria-label="Про кондитерську" className="max-w-7xl mx-auto px-4 md:px-10 py-16">
                ...
                <article className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 mb-12">
                    <div className="prose prose-sm md:prose-base max-w-none text-gray-600 space-y-4">
                        ...
                        <p>Компактний формат для персональних привітань — ідеальний подарунок, коли торт потрібен для однієї людини. <Link to="/bento-torty/" className="text-[#7A0019] font-semibold underline underline-offset-2 hover:text-[#9C142B]">Бенто-торти на замовлення в Києві →</Link></p>
                        ...
                        <p>Потрібен <strong>торт з доставкою</strong> додому, <strong>доставка в ресторан</strong> чи офіс? Час подачі, температурний режим та формат транспортування узгоджуються заздалегідь. Кондитер особисто передає виріб водію з детальними інструкціями. <Link to="/dostavka/" className="text-[#7A0019] font-semibold underline underline-offset-2 hover:text-[#9C142B]">Доставка тортів по Києву — умови та райони →</Link></p>
