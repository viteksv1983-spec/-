            ...
            <section aria-label="Про кондитерську" className="max-w-7xl mx-auto px-4 md:px-10 py-16">
                ...
                <article className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 mb-12">
                    <div className="prose prose-sm md:prose-base max-w-none text-gray-600 space-y-4">
                        ...
                        <p>Доставляємо торти у Печерський, Шевченківський, Голосіївський, Солом'янський, Дарницький, Оболонський, Подільський райони Києва, а також на лівий і правий берег міста.</p>
                        ...
                        <ul className="list-disc pl-5 space-y-1 mt-3">
                            ...
                            <li>Торти від 1 кг — від 650 грн</li>
                            <li>Весільні торти — індивідуальний розрахунок</li>
                            <li>Корпоративні торти — прорахунок за запитом</li>
                        </ul>
