...
<h2>Авторські весільні торти для особливого дня</h2>
<p>Весільний торт — це не просто десерт, а фінальний акцент вашого святкового вечора. У кондитерській Antreme ми створюємо весільні торти на замовлення в Києві з урахуванням стилю події, кількості гостей та ваших смакових побажань. Понад 20 років досвіду та 6000+ виконаних замовлень дозволяють нам гарантувати бездоганний результат.</p>

<p>Ми працюємо індивідуально з кожною парою: від ескізу та підбору начинки до доставки й встановлення торта на локації. Кожен проєкт — унікальний.</p>

<h2>Скільки коштує весільний торт у Києві</h2>
<p>Вартість весільного торта залежить від ваги, кількості ярусів, складності декору та вибраної начинки.</p>

<ul>
<li>Мінімальна ціна — від 950 грн за кг</li>
<li>Середня вага торта на 30 гостей — 5–6 кг</li>
<li>Декор з живими квітами або ручний розпис розраховується окремо</li>
</ul>

<p>Ми надаємо точний розрахунок вартості після узгодження деталей. Жодних прихованих доплат.</p>

<h2>Популярні стилі весільних тортів</h2>
<ul>
<li>Мінімалістичні білі торти</li>
<li>Багатоярусні класичні композиції</li>
<li>Торти з живими квітами</li>
<li>Торти у стилі бохо або рустік</li>
<li>Сучасні дизайни з текстурним покриттям</li>
</ul>

<p>Переглянути інші варіанти дизайнів можна у розділі <a href="/torty-na-zamovlennya/">торти на замовлення</a>.</p>

<h2>Начинки для весільних тортів</h2>
<p>Ми пропонуємо понад 10 авторських начинок. Найпопулярніші:</p>
...
<li>Карамельний банан</li>
</ul>

<p>Повний перелік доступний у розділі <a href="/nachynky/">начинки для тортів</a>.</p>

<h2>Доставка та встановлення у Києві</h2>
<p>Ми доставляємо весільні торти у всі райони Києва: Печерський, Шевченківський, Голосіївський, Солом'янський, Дарницький, Оболонський та інші. За потреби виконуємо монтаж багатоярусних конструкцій безпосередньо на локації.</p>

<h2>Як замовити весільний торт</h2>
<ol>
<li>Зв'яжіться з нами та повідомте дату весілля</li>
<li>Узгодьте дизайн та начинку</li>
<li>Отримайте розрахунок вартості</li>
<li>Внесіть передоплату для бронювання дати</li>
</ol>

<h2>Поширені запитання</h2>

<h3>За скільки часу потрібно замовляти?</h3>
<p>Рекомендуємо оформити замовлення за 2–4 тижні до дати весілля.</p>

<h3>Чи можна провести дегустацію?</h3>
<p>Так, за попереднім записом доступна дегустація начинок.</p>

<h3>Чи доставляєте за межі Києва?</h3>
<p>Так, умови обговорюються індивідуально.</p>
