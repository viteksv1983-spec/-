...
def optimize_chef_photo(input_path_str, output_path_str, max_dimension=800):
    ...
    try:
        ...
        # Convert to RGB if it's not already (to avoid issues with P/RGBA when saving as WebP)
        if img.mode != 'RGB':
...
if __name__ == "__main__":
    input_file = "C:/Users/Виктор/.gemini/antigravity/brain/f49bc0d3-4031-4caf-8726-fd699d1b4a8e/uploaded_media_1771953407306.img"
    # Output 1: For the Home page
    out_home = "frontend/public/images/confectioner.webp"
    # Output 2: For the About page 
